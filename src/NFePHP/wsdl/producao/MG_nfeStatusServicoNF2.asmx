...
<wsdl:definitions name="NfeStatusServico2" targetNamespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2" xmlns:ns1="http://schemas.xmlsoap.org/soap/http" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:tns="http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  <wsdl:types>
<xs:schema attributeFormDefault="unqualified" elementFormDefault="qualified" targetNamespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2" xmlns:tns="http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2" xmlns:xs="http://www.w3.org/2001/XMLSchema">
<xs:import namespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2"/>
...
<xs:complexType mixed="true" name="nfeStatusServicoNF2Result">
<xs:sequence>
<xs:element maxOccurs="unbounded" minOccurs="0" ref="retConsStatServ"/>
</xs:sequence>
</xs:complexType>
...
<xs:schema attributeFormDefault="unqualified" elementFormDefault="unqualified" targetNamespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2" xmlns="http://www.portalfiscal.inf.br/nfe/wsdl/NfeStatusServico2" xmlns:xs="http://www.w3.org/2001/XMLSchema">
...
<xs:element minOccurs="0" name="tMed" type="xs:string"/>
<xs:element minOccurs="0" name="dhRetorno" type="xs:anySimpleType"/>
<xs:element minOccurs="0" name="xObs" type="xs:string"/>
</xs:sequence>
...
<xs:attribute name="versao" type="xs:string" use="required"/>
  ...
  <wsdl:service name="NfeStatusServico2">
    <wsdl:port binding="tns:NfeStatusServico2SoapBinding" name="NfeStatusServico2Soap12">
      <soap12:address location="https://nfe.fazenda.mg.gov.br/nfe2/services/NfeStatusServico2"/>
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>