...
<wsdl:definitions name="NfeConsulta2" targetNamespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2" xmlns:ns1="http://schemas.xmlsoap.org/soap/http" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:tns="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  <wsdl:types>
<xs:schema attributeFormDefault="unqualified" elementFormDefault="qualified" targetNamespace="http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento" xmlns:tns="http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento" xmlns:xs="http://www.w3.org/2001/XMLSchema">
<xs:import namespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2"/>
...
<xs:element name="nfeRecepcaoEventoResult" type="tns:nfeRecepcaoEventoResult"/>
<xs:complexType mixed="true" name="nfeRecepcaoEventoResult">
<xs:sequence>
<xs:element maxOccurs="unbounded" minOccurs="0" ref="retEnvEvento"/>
</xs:sequence>
</xs:complexType>
...
<xs:schema attributeFormDefault="unqualified" elementFormDefault="qualified" targetNamespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2" xmlns:tns="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2" xmlns:xs="http://www.w3.org/2001/XMLSchema">
<xs:import namespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2"/>
<xs:element name="nfeCabecMsg" type="tns:nfeCabecMsg"/>
...
<xs:complexType mixed="true" name="nfeConsultaNF2Result">
<xs:sequence>
<xs:element maxOccurs="unbounded" minOccurs="0" ref="retConsSitNFe"/>
</xs:sequence>
</xs:complexType>
<xs:complexType name="nfeCabecMsg">
<xs:sequence>
...
<xs:schema attributeFormDefault="unqualified" elementFormDefault="unqualified" targetNamespace="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2" xmlns="http://www.portalfiscal.inf.br/nfe/wsdl/NfeConsulta2" xmlns:xs="http://www.w3.org/2001/XMLSchema">
<xs:element>
<xs:complexType>
<xs:sequence>
...
<xs:element name="detEvento" nillable="true" type="xs:anyType"/>
...
<xs:element name="cOrgao" type="xs:string"/>
<xs:element name="cStat" type="xs:string"/>
<xs:element name="xMotivo" type="xs:string"/>
<xs:element maxOccurs="unbounded" minOccurs="0" name="retEvento">
<xs:complexType>
<xs:sequence>
...
<xs:sequence>
<xs:element name="tpAmb" type="xs:string"/>
<xs:element minOccurs="0" name="verAplic" type="xs:string"/>
<xs:element name="cOrgao" type="xs:string"/>
<xs:element name="cStat" type="xs:string"/>
<xs:element name="xMotivo" type="xs:string"/>
<xs:element name="chNFe" type="xs:string"/>
<xs:element name="tpEvento" type="xs:string"/>
<xs:element minOccurs="0" name="xEvento" type="xs:string"/>
<xs:element minOccurs="0" name="nSeqEvento" type="xs:string"/>
<xs:element minOccurs="0" name="CNPJDest" type="xs:string"/>
<xs:element minOccurs="0" name="CPFDest" type="xs:string"/>
<xs:element minOccurs="0" name="emailDest" type="xs:string"/>
<xs:element minOccurs="0" name="dhRegEvento" type="xs:string"/>
...
<xs:element minOccurs="0" name="nProt" type="xs:string"/>
<xs:element minOccurs="0" name="digVal" type="xs:base64Binary"/>
</xs:sequence>
<xs:attribute name="Id" type="xs:ID"/>
</xs:complexType>
</xs:element>
...
<xs:element minOccurs="0" name="retCancNFe" type="TRetCancNFe"/>
<xs:element maxOccurs="unbounded" minOccurs="0" name="procEventoNFe">
<xs:complexType>
<xs:sequence>
<xs:element name="evento">
<xs:complexType>
<xs:sequence>
<xs:element minOccurs="0" name="infEvento">
<xs:complexType>
<xs:sequence>
<xs:element name="cOrgao" type="xs:string"/>
<xs:element name="tpAmb" type="xs:string"/>
...
<xs:element name="chNFe" type="xs:string"/>
<xs:element minOccurs="0" name="dhEvento" type="xs:string"/>
<xs:element name="tpEvento" type="xs:string"/>
<xs:element minOccurs="0" name="nSeqEvento" type="xs:string"/>
<xs:element minOccurs="0" name="verEvento" type="xs:string"/>
...
<xs:element name="xMotivo" type="xs:string"/>
<xs:element name="cUF" type="xs:string"/>
<xs:element minOccurs="0" name="chNFe" type="xs:string"/>
...
<xs:complexType name="tDetEventoCartaCorrecao">
<xs:complexContent>
<xs:extension base="detEvento">
<xs:sequence>
<xs:element name="descEvento" type="xs:string"/>
<xs:element name="xCorrecao" type="xs:string"/>
<xs:element name="xCondUso" type="xs:string"/>
</xs:sequence>
</xs:extension>
</xs:complexContent>
</xs:complexType>
...
<xs:complexType name="tDetEventoCancelamento">
<xs:complexContent>
<xs:extension base="detEvento">
<xs:sequence>
<xs:element name="descEvento" type="xs:string"/>
...
<xs:complexType name="tDetEventoManifConfirmacaoRecebimento">
<xs:complexContent>
<xs:extension base="detEvento">
<xs:sequence>
<xs:element name="descEvento" type="xs:string"/>
...
<xs:complexType name="tDeEventoManifCienciaOperacao">
<xs:complexContent>
<xs:extension base="detEvento">
<xs:sequence>
<xs:element name="descEvento" type="xs:string"/>
...
<xs:complexType name="tDeEventoManifDesconhecimentoOperacao">
<xs:complexContent>
<xs:extension base="detEvento">
<xs:sequence>
<xs:element name="descEvento" type="xs:string"/>
...
<xs:complexType name="tDetEventoManifDevolucaoMercadoria">
<xs:complexContent>
<xs:extension base="detEvento">
<xs:sequence>
<xs:element name="descEvento" type="xs:string"/>
