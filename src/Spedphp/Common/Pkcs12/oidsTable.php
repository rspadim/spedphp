...
/*
 * Tabela dos códigos OID 
 * Object Identifier - Identificação de objetos de dados contidos
 * nos certificados conforme padrão X.509
 * Os OIDs são associados com objetos na estrutura de dados 
 * definida, usando o padrão Abstract Syntax Notation number One (ASN.1)
 */
